...
public class Fpp implements VotingSystem {
    ...
    public void votingCycle() {
        ...
        for (int i = 1; i <= voters; i++) {
            // now we are using the helper method which will print the prompt for the voting
            // for the user.
            printThePromt();
    ...
    public void printThePromt() {
        ...
        for (int i = 1; i <= candidates.length; i++) {
            ...
            // now we will use a method which will take the user input and return it to the
            // print the promt and then print the promt method will return that to different
            // method.
    ...
    // this method will take the voters choice and check if the voter has given a
    // right choice or not and then based on the input it
    ...
    // this method will check for the winner by traversing through the array and
    // giving the deserving candidate the crown.
